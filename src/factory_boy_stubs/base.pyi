...
class OptionDefault:
    ...
    inherit: Incomplete
    checker: Incomplete
    def __init__(self, name, value, inherit: bool = ..., checker: Incomplete | None = ...) -> None: ...
...
class FactoryOptions:
    ...
    model: Incomplete
    abstract: bool
    def contribute_to_class(self, factory, meta: Incomplete | None = ..., base_meta: Incomplete | None = ..., base_factory: Incomplete | None = ..., params: Incomplete | None = ...): ...
    def next_sequence(self): ...
    def reset_sequence(self, value: Incomplete | None = ..., force: bool = ...) -> None: ...
...
class BaseFactory:
    ...
    @classmethod
    def reset_sequence(cls, value: Incomplete | None = ..., force: bool = ...) -> None: ...
    @classmethod
