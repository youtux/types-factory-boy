...
def parse_declarations(decls, base_pre: Incomplete | None = ..., base_post: Incomplete | None = ...): ...
...
class BuildStep:
    ...
    stub: Incomplete
    def __init__(self, builder, sequence, parent_step: Incomplete | None = ...) -> None: ...
    def resolve(self, declarations) -> None: ...
    @property
    def chain(self): ...
    def recurse(self, factory, declarations, force_sequence: Incomplete | None = ...): ...
...
class StepBuilder:
    ...
    def build(self, parent_step: Incomplete | None = ..., force_sequence: Incomplete | None = ...): ...
